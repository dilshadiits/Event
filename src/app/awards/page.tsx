        ...
        <main className="min-h-screen p-3 sm:p-4 md:p-8 max-w-6xl mx-auto space-y-6 sm:space-y-8">
            ...
            <section className="bg-card border border-border rounded-xl p-6 shadow-xl">
                ...
                <form onSubmit={createEvent} className="flex flex-col md:flex-row gap-4 items-end">
                    ...
                    <button
                        type="submit"
                        className="w-full md:w-auto bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-3 rounded-lg font-bold transition-colors"
                    >
                        Create
                    </button>
                </form>
