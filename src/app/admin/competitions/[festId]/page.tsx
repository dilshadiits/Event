...
export default function FestDashboardPage({ params }: { params: Promise<{ festId: string }> }) {
    ...
    const sections = [
        ...
        { href: `/admin/competitions/${festId}/participants`, icon: UserSquare2, label: 'Participants', count: counts.participants, accent: 'bg-purple-500/20 text-purple-400' },
        { href: `/admin/competitions/${festId}/programs`, icon: ListChecks, label: 'Programs', count: counts.programs, accent: 'bg-pink-500/20 text-pink-400' },
        { href: `/admin/competitions/${festId}/judges`, icon: Gavel, label: 'Judges & Admins', count: counts.judges, accent: 'bg-orange-500/20 text-orange-400' },
        { href: `/admin/competitions/${festId}/standings`, icon: Trophy, label: 'Standings', count: undefined, accent: 'bg-yellow-500/20 text-yellow-400' },
        { href: `/admin/competitions/${festId}/certificates`, icon: Award, label: 'Certificates & Posters', count: undefined, accent: 'bg-green-500/20 text-green-400' },
    ];
